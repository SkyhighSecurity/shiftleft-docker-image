...
/* 240 */     return (super.hasHandlers() || this._valueType.hasHandlers() || this._keyType
/* 241 */       .hasHandlers());
/*     */   }
/*     */ 
/*     */   
...
/* 266 */     return new MapLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._keyType
/* 267 */         .withTypeHandler(h), this._valueType, this._valueHandler, this._typeHandler, this._asStatic);
/*     */   }
/*     */ 
/*     */   
/*     */   public MapLikeType withKeyValueHandler(Object h) {
/* 272 */     return new MapLikeType(this._class, this._bindings, this._superClass, this._superInterfaces, this._keyType
/* 273 */         .withValueHandler(h), this._valueType, this._valueHandler, this._typeHandler, this._asStatic);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 294 */     return String.format("[map-like type; class %s, %s -> %s]", new Object[] { this._class
/* 295 */           .getName(), this._keyType, this._valueType });
/*     */   }
/*     */ 
/*     */   
...
/* 305 */     return (this._class == other._class && this._keyType.equals(other._keyType) && this._valueType
/* 306 */       .equals(other._valueType));
/*     */   }
/*     */ }


/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\type\MapLikeType.class
