...
/* 296 */             .typeId(value, JsonToken.START_ARRAY));
/* 297 */         _writeArrayContents(g, value);
/*     */       } else {
/* 299 */         typeIdDef = typeSer.writeTypePrefix(g, typeSer
/* 300 */             .typeId(value, JsonToken.VALUE_STRING));
...
/*     */     
/*     */     public JsonNode getSchema(SerializerProvider provider, Type typeHint) {
/* 481 */       return createSchemaNode("array", true)
/* 482 */         .set("items", (JsonNode)createSchemaNode("number", true));
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\ser\std\StdArraySerializers.class
