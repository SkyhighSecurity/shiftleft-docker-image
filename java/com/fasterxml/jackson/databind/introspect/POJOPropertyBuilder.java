...
/*      */ {
/*   30 */   private static final AnnotationIntrospector.ReferenceProperty NOT_REFEFERENCE_PROP = AnnotationIntrospector.ReferenceProperty.managed("");
/*      */ 
/*      */ 
/*      */   
...
/*  177 */     return (member == null || this._annotationIntrospector == null) ? null : this._annotationIntrospector
/*  178 */       .findWrapperName(member);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  191 */     return (_anyExplicits(this._fields) || 
/*  192 */       _anyExplicits(this._getters) || 
/*  193 */       _anyExplicits(this._setters) || 
/*      */ 
/*      */ 
/*      */ 
/*      */       
/*  198 */       _anyExplicitNames(this._ctorParameters));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   public boolean isExplicitlyNamed() {
/*  204 */     return (_anyExplicitNames(this._fields) || 
/*  205 */       _anyExplicitNames(this._getters) || 
/*  206 */       _anyExplicitNames(this._setters) || 
/*  207 */       _anyExplicitNames(this._ctorParameters));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  225 */         this
/*  226 */           ._metadata = (desc == null) ? PropertyMetadata.STD_REQUIRED_OR_OPTIONAL : PropertyMetadata.STD_REQUIRED_OR_OPTIONAL.withDescription(desc);
/*      */       } else {
...
/*      */       } else {
/*      */         
/*  432 */         throw new IllegalArgumentException("Conflicting getter definitions for property \"" + getName() + "\": " + ((AnnotatedMethod)curr.value)
/*  433 */             .getFullName() + " vs " + ((AnnotatedMethod)next.value).getFullName());
/*      */       }  continue;
/*      */     } 
...
/*      */         continue;
/*      */       } 
/*  484 */       if (this._annotationIntrospector != null) {
...
/*      */         } 
/*      */       } 
/*  497 */       throw new IllegalArgumentException(String.format("Conflicting setter definitions for property \"%s\": %s vs %s", new Object[] {
/*      */               
/*  499 */               getName(), ((AnnotatedMethod)curr.value).getFullName(), ((AnnotatedMethod)next.value).getFullName()
/*      */             }));
/*      */     } 
...
/*      */         }
/*      */       } 
/*  528 */       throw new IllegalArgumentException("Multiple fields representing property \"" + getName() + "\": " + field
/*  529 */           .getFullName() + " vs " + nextField.getFullName());
/*      */     } 
/*  531 */     return field;
/*      */   }
/*      */ 
...
/*      */ 
/*      */     
/*  709 */     JsonInclude.Value v = (this._annotationIntrospector == null) ? null : this._annotationIntrospector.findPropertyInclusion(a);
...
/*  976 */     return (_anyVisible(this._fields) || 
/*  977 */       _anyVisible(this._getters) || 
/*  978 */       _anyVisible(this._setters) || 
/*  979 */       _anyVisible(this._ctorParameters));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  994 */     return (_anyIgnorals(this._fields) || 
/*  995 */       _anyIgnorals(this._getters) || 
/*  996 */       _anyIgnorals(this._setters) || 
/*  997 */       _anyIgnorals(this._ctorParameters));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/* 1117 */     sb.append("[Property '").append(this._name)
/* 1118 */       .append("'; ctors: ").append(this._ctorParameters)
/* 1119 */       .append(", field(s): ").append(this._fields)
/* 1120 */       .append(", getter(s): ").append(this._getters)
/* 1121 */       .append(", setter(s): ").append(this._setters);
/*      */     
/* 1123 */     sb.append("]");
...
/*      */     
/*      */     public String toString() {
/* 1376 */       String msg = String.format("%s[visible=%b,ignore=%b,explicitName=%b]", new Object[] { this.value
/* 1377 */             .toString(), Boolean.valueOf(this.isVisible), Boolean.valueOf(this.isMarkedIgnored), Boolean.valueOf(this.isNameExplicit) });
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\introspect\POJOPropertyBuilder.class
