...
/*  42 */     this
/*  43 */       ._intr = config.isAnnotationProcessingEnabled() ? config.getAnnotationIntrospector() : null;
...
/*     */     } else {
/*  57 */       this
/*  58 */         ._intr = config.isAnnotationProcessingEnabled() ? config.getAnnotationIntrospector() : null;
...
/* 117 */     return new AnnotatedClass(this._type, this._class, superTypes, this._primaryMixin, 
/* 118 */         resolveClassAnnotations(superTypes), this._bindings, this._intr, this._mixInResolver, this._config
/* 119 */         .getTypeFactory());
/*     */   }
/*     */ 
/*     */   
...
/* 125 */     return new AnnotatedClass(null, this._class, superTypes, this._primaryMixin, 
/* 126 */         resolveClassAnnotations(superTypes), this._bindings, this._intr, (ClassIntrospector.MixInResolver)this._config, this._config
/* 127 */         .getTypeFactory());
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 153 */     resolvedCA = _addAnnotationsIfNotPresent(resolvedCA, 
/* 154 */         ClassUtil.findClassAnnotations(this._class));
/*     */ 
/*     */     
...
/* 161 */         resolvedCA = _addClassMixIns(resolvedCA, cls, this._mixInResolver
/* 162 */             .findMixInClassFor(cls));
/*     */       } 
/* 164 */       resolvedCA = _addAnnotationsIfNotPresent(resolvedCA, 
/* 165 */           ClassUtil.findClassAnnotations(type.getRawClass()));
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 174 */       resolvedCA = _addClassMixIns(resolvedCA, Object.class, this._mixInResolver
/* 175 */           .findMixInClassFor(Object.class));
/*     */     }
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\introspect\AnnotatedClassResolver.class
