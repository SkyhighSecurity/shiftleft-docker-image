...
/* 155 */               result.set(j, 
/* 156 */                   constructNonDefaultConstructor(ctors.get(j), mixinCtor));
/*     */               
/*     */               break;
/*     */             } 
/*     */           } 
...
/* 169 */       if (ctor == null) {
/* 170 */         result.set(i, 
/* 171 */             constructNonDefaultConstructor(ctors.get(i), (ClassUtil.Ctor)null));
/*     */       }
/*     */     } 
/* 174 */     return result;
/*     */   }
...
/* 218 */               result.set(j, 
/* 219 */                   constructFactoryCreator(candidates.get(j), mixinFactory));
/*     */               break;
/*     */             } 
/*     */           } 
/*     */         } 
...
/* 228 */       if (factory == null) {
/* 229 */         result.set(i, 
/* 230 */             constructFactoryCreator(candidates.get(i), (Method)null));
/*     */       }
/*     */     } 
/* 233 */     return result;
/*     */   }
...
/* 240 */       return new AnnotatedConstructor(this._typeContext, ctor.getConstructor(), 
/* 241 */           _emptyAnnotationMap(), NO_ANNOTATION_MAPS);
/*     */     }
/* 243 */     return new AnnotatedConstructor(this._typeContext, ctor.getConstructor(), 
/* 244 */         collectAnnotations(ctor, mixin), NO_ANNOTATION_MAPS);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 254 */       return new AnnotatedConstructor(this._typeContext, ctor.getConstructor(), 
/* 255 */           _emptyAnnotationMap(), _emptyAnnotationMaps(paramCount));
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 262 */     if (paramCount == 0) {
/* 263 */       return new AnnotatedConstructor(this._typeContext, ctor.getConstructor(), 
/* 264 */           collectAnnotations(ctor, mixin), NO_ANNOTATION_MAPS);
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 294 */         throw new IllegalStateException(String.format("Internal error: constructor for %s has mismatch: %d parameters; %d sets of annotations", new Object[] { ctor
/*     */                 
/* 296 */                 .getDeclaringClass().getName(), Integer.valueOf(paramCount), Integer.valueOf(paramAnns.length) }));
/*     */       }
/*     */     } else {
/* 299 */       resolvedAnnotations = collectAnnotations(paramAnns, (mixin == null) ? (Annotation[][])null : mixin
/* 300 */           .getParameterAnnotations());
/*     */     } 
/* 302 */     return new AnnotatedConstructor(this._typeContext, ctor.getConstructor(), 
/* 303 */         collectAnnotations(ctor, mixin), resolvedAnnotations);
/*     */   }
/*     */ 
/*     */   
...
/* 310 */       return new AnnotatedMethod(this._typeContext, m, _emptyAnnotationMap(), 
/* 311 */           _emptyAnnotationMaps(paramCount));
/*     */     }
/* 313 */     if (paramCount == 0) {
/* 314 */       return new AnnotatedMethod(this._typeContext, m, collectAnnotations(m, mixin), NO_ANNOTATION_MAPS);
/*     */     }
/*     */     
/* 317 */     return new AnnotatedMethod(this._typeContext, m, collectAnnotations(m, mixin), 
/* 318 */         collectAnnotations(m.getParameterAnnotations(), (mixin == null) ? (Annotation[][])null : mixin
/* 319 */           .getParameterAnnotations()));
/*     */   }
/*     */   
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\introspect\AnnotatedCreatorCollector.class
