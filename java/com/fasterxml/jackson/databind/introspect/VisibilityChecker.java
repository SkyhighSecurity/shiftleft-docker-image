...
/* 264 */       if (ann != null) {
/* 265 */         return _with(
/* 266 */             _defaultOrOverride(this._getterMinLevel, ann.getterVisibility()), 
/* 267 */             _defaultOrOverride(this._isGetterMinLevel, ann.isGetterVisibility()), 
/* 268 */             _defaultOrOverride(this._setterMinLevel, ann.setterVisibility()), 
/* 269 */             _defaultOrOverride(this._creatorMinLevel, ann.creatorVisibility()), 
/* 270 */             _defaultOrOverride(this._fieldMinLevel, ann.fieldVisibility()));
/*     */       }
/*     */       
/* 273 */       return curr;
/*     */     }
...
/* 280 */       if (vis != null) {
/* 281 */         return _with(
/* 282 */             _defaultOrOverride(this._getterMinLevel, vis.getGetterVisibility()), 
/* 283 */             _defaultOrOverride(this._isGetterMinLevel, vis.getIsGetterVisibility()), 
/* 284 */             _defaultOrOverride(this._setterMinLevel, vis.getSetterVisibility()), 
/* 285 */             _defaultOrOverride(this._creatorMinLevel, vis.getCreatorVisibility()), 
/* 286 */             _defaultOrOverride(this._fieldMinLevel, vis.getFieldVisibility()));
/*     */       }
/*     */       
/* 289 */       return curr;
/*     */     }
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\introspect\VisibilityChecker.class
