...
/* 143 */             if (idProp == null)
/* 144 */               ctxt.reportBadDefinition(this._baseType, String.format("Invalid Object Id definition for %s: cannot find property with name '%s'", new Object[] {
/*     */                       
/* 146 */                       handledType().getName(), propName
/*     */                     })); 
...
/* 241 */           t = p.nextToken();
/*     */         }
/* 243 */         if (t == JsonToken.FIELD_NAME && this._objectIdReader.maySerializeAsObject() && this._objectIdReader
/* 244 */           .isValidReferencePropertyName(p.getCurrentName(), p)) {
...
/* 323 */     if (pojo == null) {
/* 324 */       throw new UnresolvedForwardReference(p, "Could not resolve Object Id [" + id + "] -- unresolved forward-reference?", p
/* 325 */           .getCurrentLocation(), roid);
/*     */     }
/* 327 */     return pojo;
/*     */   }
/*     */ }
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\deser\AbstractDeserializer.class
