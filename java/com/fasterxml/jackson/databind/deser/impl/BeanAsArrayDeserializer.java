...
/* 130 */       ctxt.reportWrongTokenException((JsonDeserializer)this, JsonToken.END_ARRAY, "Unexpected JSON values; expected at most %d properties (in JSON Array)", new Object[] {
/*     */             
/* 132 */             Integer.valueOf(propCount)
/*     */           });
/*     */     }
/*     */     
/*     */     while (true) {
...
/* 184 */       ctxt.reportWrongTokenException((JsonDeserializer)this, JsonToken.END_ARRAY, "Unexpected JSON values; expected at most %d properties (in JSON Array)", new Object[] {
/*     */             
/* 186 */             Integer.valueOf(propCount)
/*     */           });
/*     */     }
/*     */     
/*     */     while (true) {
...
/* 255 */       ctxt.reportWrongTokenException((JsonDeserializer)this, JsonToken.END_ARRAY, "Unexpected JSON values; expected at most %d properties (in JSON Array)", new Object[] {
/*     */             
/* 257 */             Integer.valueOf(propCount)
/*     */           });
/*     */     }
/*     */     
/*     */     while (true) {
...
/*     */ 
/*     */               
/* 329 */               ctxt.reportBadDefinition(this._beanType, String.format("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type %s, actual type %s", new Object[] { this._beanType
/*     */ 
/*     */                       
/* 332 */                       .getRawClass().getName(), bean.getClass().getName() }));
/*     */             
/*     */             }
/*     */           }
/*     */         
...
/* 365 */     String message = "Cannot deserialize a POJO (of type %s) from non-Array representation (token: %s): type/property designed to be serialized as JSON Array";
/*     */     
/* 367 */     return ctxt.handleUnexpectedToken(getValueType(ctxt), p.getCurrentToken(), p, message, new Object[] { this._beanType.getRawClass().getName(), p.getCurrentToken() });
/*     */   }
/*     */ }


/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\deser\impl\BeanAsArrayDeserializer.class
