...
/*     */     Object value, result[];
/* 310 */     if (p.hasToken(JsonToken.VALUE_STRING) && ctxt
/* 311 */       .isEnabled(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT)) {
...
/*     */ 
/*     */     
/* 321 */     boolean canWrap = (this._unwrapSingle == Boolean.TRUE || (this._unwrapSingle == null && ctxt.isEnabled(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY)));
/* 322 */     if (!canWrap) {
/*     */       
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\deser\std\ObjectArrayDeserializer.class
