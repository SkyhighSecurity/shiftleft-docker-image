...
/* 300 */     boolean canWrap = (this._unwrapSingle == Boolean.TRUE || (this._unwrapSingle == null && ctxt.isEnabled(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY)));
/* 301 */     if (canWrap) {
/*     */ 
/*     */       
/* 304 */       String value = p.hasToken(JsonToken.VALUE_NULL) ? (String)this._nullProvider.getNullValue(ctxt) : _parseString(p, ctxt);
/* 305 */       return new String[] { value };
/*     */     } 
/* 307 */     if (p.hasToken(JsonToken.VALUE_STRING) && ctxt
/* 308 */       .isEnabled(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT)) {
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\deser\std\StringArrayDeserializer.class
