...
/* 156 */         ctxt.reportInputMismatch(this, "Cannot map `null` into type %s (set DeserializationConfig.DeserializationFeature.FAIL_ON_NULL_FOR_PRIMITIVES to 'false' to allow)", new Object[] {
/*     */               
/* 158 */               handledType().toString()
/*     */             }); 
...
/* 514 */                 return (Integer)ctxt.handleWeirdStringValue(this._valueClass, text, String.format("Overflow: numeric value (%s) out of range of Integer (%d - %d)", new Object[] { text, 
/*     */                         
/* 516 */                         Integer.valueOf(-2147483648), Integer.valueOf(2147483647) }), new Object[0]);
/*     */               }
...
/* 654 */         } catch (IllegalArgumentException illegalArgumentException) {
...
/* 730 */         } catch (IllegalArgumentException illegalArgumentException) {
...
/* 913 */           } catch (IllegalArgumentException illegalArgumentException) {
...
/* 954 */           } catch (IllegalArgumentException illegalArgumentException) {
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\deser\std\NumberDeserializers.class
