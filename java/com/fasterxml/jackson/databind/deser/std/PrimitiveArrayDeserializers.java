...
/* 228 */     if (p.hasToken(JsonToken.VALUE_STRING) && ctxt
/* 229 */       .isEnabled(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT) && 
/* 230 */       p.getText().length() == 0) {
/* 231 */       return null;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/* 236 */     boolean canWrap = (this._unwrapSingle == Boolean.TRUE || (this._unwrapSingle == null && ctxt.isEnabled(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY)));
/* 237 */     if (canWrap) {
...
/*     */           } 
/* 313 */           if (str.length() != 1)
/* 314 */             ctxt.reportInputMismatch(this, "Cannot convert a JSON String of length %d into a char element of char array", new Object[] {
/* 315 */                   Integer.valueOf(str.length())
/*     */                 }); 
...
/* 484 */             return (byte[])ctxt.handleWeirdStringValue(byte[].class, p
/* 485 */                 .getText(), msg, new Object[0]);
/*     */           }
/*     */         } 
/*     */       }
/*     */       
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\deser\std\PrimitiveArrayDeserializers.class
