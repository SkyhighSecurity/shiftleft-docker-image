...
/*     */     } else {
/* 308 */       result = this._dynamicSerializers.addSerializer(type, (JsonSerializer)new TypeWrappedSerializer(this._typeSerializer, this._provider
/* 309 */             .findValueSerializer(type, null)));
/*     */     } 
...
/*     */     } else {
/* 321 */       result = this._dynamicSerializers.addSerializer(type, (JsonSerializer)new TypeWrappedSerializer(this._typeSerializer, this._provider
/* 322 */             .findValueSerializer(type, null)));
/*     */     } 
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\SequenceWriter.class
