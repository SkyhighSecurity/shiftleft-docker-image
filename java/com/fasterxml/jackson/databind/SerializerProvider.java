...
/*  714 */     TypeSerializer typeSer = this._serializerFactory.createTypeSerializer(this._config, this._config
/*  715 */         .constructType(valueType));
/*  716 */     if (typeSer != null) {
...
/*      */     }
/* 1161 */     msg = String.format("Invalid type definition for type %s: %s", new Object[] { beanDesc, 
/* 1162 */           _format(msg, msgArgs) });
...
/*      */       }
/*      */     } 
/* 1284 */     reportBadDefinition(rootType, String.format("Incompatible types: declared root type (%s) vs %s", new Object[] { rootType, 
/*      */             
/* 1286 */             ClassUtil.classNameOf(value) }));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     try {
/* 1336 */       ser = _createUntypedSerializer(fullType);
/* 1337 */     } catch (IllegalArgumentException iae) {
/*      */ 
/*      */       
/* 1340 */       ser = null;
/* 1341 */       reportMappingProblem(iae, ClassUtil.exceptionMessage(iae), new Object[0]);
/*      */     } 
/*      */     
/* 1344 */     if (ser != null)
/*      */     {
/* 1346 */       this._serializerCache.addAndResolveNonTypedSerializer(rawType, fullType, ser, this);
/*      */     }
/* 1348 */     return ser;
/*      */   }
/*      */ 
...
/*      */     JsonSerializer<Object> ser;
/*      */     try {
/* 1356 */       ser = _createUntypedSerializer(type);
/* 1357 */     } catch (IllegalArgumentException iae) {
/*      */ 
/*      */       
/* 1360 */       ser = null;
/* 1361 */       reportMappingProblem(iae, ClassUtil.exceptionMessage(iae), new Object[0]);
/*      */     } 
/*      */     
/* 1364 */     if (ser != null)
/*      */     {
/* 1366 */       this._serializerCache.addAndResolveNonTypedSerializer(type, ser, this);
/*      */     }
/* 1368 */     return ser;
/*      */   }
/*      */ 
...
/* 1386 */     synchronized (this._serializerCache) {
/*      */       
/* 1388 */       return this._serializerFactory.createSerializer(this, type);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1401 */     if (ser instanceof ResolvableSerializer) {
/* 1402 */       ((ResolvableSerializer)ser).resolve(this);
/*      */     }
/* 1404 */     return (JsonSerializer)handleSecondaryContextualization(ser, property);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1411 */     if (ser instanceof ResolvableSerializer) {
/* 1412 */       ((ResolvableSerializer)ser).resolve(this);
/*      */     }
/* 1414 */     return (JsonSerializer)ser;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1425 */     if (this._dateFormat != null) {
/* 1426 */       return this._dateFormat;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 1432 */     DateFormat df = this._config.getDateFormat();
/* 1433 */     this._dateFormat = df = (DateFormat)df.clone();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\databind\SerializerProvider.class
