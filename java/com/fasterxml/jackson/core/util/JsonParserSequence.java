...
/* 100 */       p.add(second);
/*     */     } 
/* 102 */     return new JsonParserSequence(checkForExistingToken, p
/* 103 */         .<JsonParser>toArray(new JsonParser[p.size()]));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 165 */     if (this.delegate.currentToken() != JsonToken.START_OBJECT && this.delegate
/* 166 */       .currentToken() != JsonToken.START_ARRAY) {
/* 167 */       return this;
/*     */     }
/* 169 */     int open = 1;
/*     */ 
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\cor\\util\JsonParserSequence.class
