...
/* 605 */         if ((f == TokenFilter.INCLUDE_ALL || (f != null && f
/* 606 */           .includeValue(this.delegate))) && 
/* 607 */           _verifyAllowedMatches()) {
...
/* 741 */         if ((f == TokenFilter.INCLUDE_ALL || (f != null && f
/* 742 */           .includeValue(this.delegate))) && 
/* 743 */           _verifyAllowedMatches()) {
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\core\filter\FilteringParserDelegate.class
