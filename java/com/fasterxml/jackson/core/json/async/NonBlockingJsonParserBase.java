...
/* 842 */     String tokenStr = NON_STD_TOKENS[type];
/* 843 */     this._textBuffer.resetWithString(tokenStr);
/* 844 */     if (!isEnabled(JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS)) {
/* 845 */       _reportError("Non-standard token '%s': enable JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS to allow", tokenStr);
/*     */     }
/*     */     
/* 848 */     this._intLength = 0;
/* 849 */     this._numTypesValid = 8;
/* 850 */     this._numberDouble = NON_STD_TOKEN_VALUES[type];
/* 851 */     this._majorState = this._majorStateAfterValue;
/* 852 */     return this._currToken = JsonToken.VALUE_NUMBER_FLOAT;
/*     */   }
/*     */   
/*     */   protected final String _nonStdToken(int type) {
/* 856 */     return NON_STD_TOKENS[type];
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 867 */     this._tokenInputRow = Math.max(this._currInputRow, this._currInputRowAlt);
/* 868 */     int ptr = this._inputPtr;
/* 869 */     this._tokenInputCol = ptr - this._currInputRowStart;
/* 870 */     this._tokenInputTotal = this._currInputProcessed + (ptr - this._currBufferStart);
/*     */   }
/*     */ 
/*     */   
/*     */   protected void _reportInvalidChar(int c) throws JsonParseException {
/* 875 */     if (c < 32) {
/* 876 */       _throwInvalidSpace(c);
/*     */     }
/* 878 */     _reportInvalidInitial(c);
/*     */   }
/*     */   
/*     */   protected void _reportInvalidInitial(int mask) throws JsonParseException {
/* 882 */     _reportError("Invalid UTF-8 start byte 0x" + Integer.toHexString(mask));
/*     */   }
/*     */   
/*     */   protected void _reportInvalidOther(int mask, int ptr) throws JsonParseException {
/* 886 */     this._inputPtr = ptr;
/* 887 */     _reportInvalidOther(mask);
/*     */   }
/*     */   
/*     */   protected void _reportInvalidOther(int mask) throws JsonParseException {
/* 891 */     _reportError("Invalid UTF-8 middle byte 0x" + Integer.toHexString(mask));
/*     */   }
/*     */ }


/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\core\json\async\NonBlockingJsonParserBase.class
