...
/* 115 */     if (ctxt == null) {
/* 116 */       this
/* 117 */         ._child = ctxt = new JsonReadContext(this, (this._dups == null) ? null : this._dups.child(), 1, lineNr, colNr);
/*     */     } else {
...
/* 126 */     if (ctxt == null) {
/* 127 */       this
/* 128 */         ._child = ctxt = new JsonReadContext(this, (this._dups == null) ? null : this._dups.child(), 2, lineNr, colNr);
/* 129 */       return ctxt;
/*     */     } 
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\fasterxml\jackson\core\json\JsonReadContext.class
