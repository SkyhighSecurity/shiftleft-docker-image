...
/*      */       }
/*  211 */       return new CustomConcurrentHashMap.Impl<K, V, E>(strategy, this);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       }
/*      */       
/*  261 */       return new CustomConcurrentHashMap.ComputingImpl<K, V, E>(strategy, this, computer);
/*      */     }
/*      */     
/*      */     int getInitialCapacity() {
/*  265 */       return (this.initialCapacity == -1) ? 16 : this.initialCapacity;
/*      */     }
/*      */ 
/*      */     
/*      */     int getConcurrencyLevel() {
/*  270 */       return (this.concurrencyLevel == -1) ? 16 : this.concurrencyLevel;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  650 */         return CustomConcurrentHashMap.Impl.this.segmentFor(hash).getEntry(key, hash);
/*      */       }
/*      */       
...
/*  689 */       return this.segments[hash >>> this.segmentShift & this.segmentMask];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  900 */         lock(); 
/*      */         try { E e;
/*  902 */           for (e = getFirst(hash); e != null; e = s.getNext(e)) {
...
/*      */           E e;
/* 1051 */           for (e = first; e != null; e = s.getNext(e)) {
...
/* 1075 */           e = null;
/*      */           
/* 1077 */           return (V)e; } finally { unlock(); }
/*      */       
/*      */       }
/*      */       
...
/* 1228 */       Segment[] segments = this.segments;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 1239 */       int mcsum = 0; int i;
/* 1240 */       for (i = 0; i < segments.length; i++) {
/* 1241 */         if ((segments[i]).count != 0) {
/* 1242 */           return false;
/*      */         }
/* 1244 */         mc[i] = (segments[i]).modCount; mcsum += (segments[i]).modCount;
/*      */       } 
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1250 */       if (mcsum != 0) {
/* 1251 */         for (i = 0; i < segments.length; i++) {
/* 1252 */           if ((segments[i]).count != 0 || mc[i] != (segments[i]).modCount)
/*      */           {
/* 1254 */             return false;
/*      */           }
/*      */         } 
...
/*      */     
/*      */     public int size() {
/* 1269 */       Segment[] segments = this.segments;
/* 1270 */       long sum = 0L;
/* 1271 */       long check = 0L;
...
/* 1276 */         check = 0L;
/* 1277 */         sum = 0L;
/* 1278 */         int mcsum = 0; int i;
/* 1279 */         for (i = 0; i < segments.length; i++) {
/* 1280 */           sum += (segments[i]).count;
/* 1281 */           mc[i] = (segments[i]).modCount; mcsum += (segments[i]).modCount;
/*      */         } 
/* 1283 */         if (mcsum != 0) {
/* 1284 */           for (i = 0; i < segments.length; i++) {
...
/*      */ 
/*      */       
/* 1368 */       Segment[] segments = this.segments;
/* 1369 */       int[] mc = new int[segments.length];
/*      */ 
/*      */       
/* 1372 */       for (int k = 0; k < 2; k++) {
/* 1373 */         int mcsum = 0;
/* 1374 */         for (int i = 0; i < segments.length; i++) {
/*      */           
/* 1376 */           int c = (segments[i]).count;
/* 1377 */           mc[i] = (segments[i]).modCount; mcsum += (segments[i]).modCount;
...
/* 1383 */         if (mcsum != 0) {
/* 1384 */           for (int j = 0; j < segments.length; j++) {
/*      */             
/* 1386 */             int c = (segments[j]).count;
/* 1387 */             if (mc[j] != (segments[j]).modCount) {
...
/* 1699 */           this.nextExternal = new CustomConcurrentHashMap.Impl.WriteThroughEntry(key, value);
/* 1700 */           return true;
/*      */         } 
/*      */         
/* 1703 */         return false;
...
/* 1708 */         return (this.nextExternal != null);
/*      */       }
/*      */       
...
/*      */       extends HashIterator implements Iterator<K> {
/*      */       public K next() {
/* 1732 */         return nextEntry().getKey();
/*      */       }
/*      */     }
/*      */     
/*      */     final class ValueIterator
/*      */       extends HashIterator implements Iterator<V> {
/*      */       public V next() {
/* 1739 */         return nextEntry().getValue();
/*      */       }
/*      */     }
/*      */ 
/*      */     
...
/* 1793 */         return new CustomConcurrentHashMap.Impl.KeyIterator();
/*      */       }
/*      */       
/*      */       public int size() {
/* 1797 */         return CustomConcurrentHashMap.Impl.this.size();
/*      */       }
/*      */       
/*      */       public boolean isEmpty() {
/* 1801 */         return CustomConcurrentHashMap.Impl.this.isEmpty();
/*      */       }
/*      */       
/*      */       public boolean contains(Object o) {
/* 1805 */         return CustomConcurrentHashMap.Impl.this.containsKey(o);
/*      */       }
/*      */       
/*      */       public boolean remove(Object o) {
/* 1809 */         return (CustomConcurrentHashMap.Impl.this.remove(o) != null);
/*      */       }
/*      */       
/*      */       public void clear() {
/* 1813 */         CustomConcurrentHashMap.Impl.this.clear();
/*      */       }
/*      */     }
/*      */     
/*      */     final class Values
...
/* 1820 */         return new CustomConcurrentHashMap.Impl.ValueIterator();
/*      */       }
/*      */       
/*      */       public int size() {
/* 1824 */         return CustomConcurrentHashMap.Impl.this.size();
/*      */       }
/*      */       
/*      */       public boolean isEmpty() {
/* 1828 */         return CustomConcurrentHashMap.Impl.this.isEmpty();
/*      */       }
/*      */       
/*      */       public boolean contains(Object o) {
/* 1832 */         return CustomConcurrentHashMap.Impl.this.containsValue(o);
/*      */       }
/*      */       
/*      */       public void clear() {
/* 1836 */         CustomConcurrentHashMap.Impl.this.clear();
/*      */       }
/*      */     }
/*      */     
...
/* 1843 */         return new CustomConcurrentHashMap.Impl.EntryIterator();
/*      */       }
/*      */       
/*      */       public boolean contains(Object o) {
...
/*      */       
/*      */       public int size() {
/* 1870 */         return CustomConcurrentHashMap.Impl.this.size();
/*      */       }
/*      */       
/*      */       public boolean isEmpty() {
/* 1874 */         return CustomConcurrentHashMap.Impl.this.isEmpty();
/*      */       }
/*      */       
/*      */       public void clear() {
/* 1878 */         CustomConcurrentHashMap.Impl.this.clear();
/*      */       }
/*      */     }
/*      */ 
/*      */ 
...
/* 1927 */         CustomConcurrentHashMap.Strategy<K, V, E> strategy = (CustomConcurrentHashMap.Strategy<K, V, E>)in.readObject();
/*      */         
...
/* 2013 */       CustomConcurrentHashMap.Impl<K, V, E>.Segment segment = segmentFor(hash);
/*      */       label53: while (true) {
...
/* 2033 */               entry = this.computingStrategy.newEntry(key, hash, first);
...
/*      */             try {
/* 2045 */               V value = this.computingStrategy.compute(key, entry, this.computer);
/* 2046 */               if (value == null) {
...
/*      */         while (true) {
/*      */           
/* 2065 */           try { V value = this.computingStrategy.waitForValue(entry);
/* 2066 */             if (value == null)
/*      */             
...
/* 2108 */       return new CustomConcurrentHashMap.SimpleInternalEntry<K, V>(key, hash, null, next);
/*      */     }
/*      */     
...
/* 2112 */       return new CustomConcurrentHashMap.SimpleInternalEntry<K, V>(key, original.hash, original.value, next);
/*      */     }
/*      */     
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\com\google\common\collect\CustomConcurrentHashMap.class
