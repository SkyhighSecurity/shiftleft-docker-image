...
/*  45 */   private final ConcurrentMap<String, Pattern> patternCache = new ConcurrentHashMap<String, Pattern>();
/*     */ 
/*     */   
...
/*     */     
/*  68 */     if (left == null) {
/*  69 */       throw new SpelEvaluationException(leftOp.getStartPosition(), SpelMessage.INVALID_FIRST_OPERAND_FOR_MATCHES_OPERATOR, new Object[] { left });
/*     */     }
/*     */     
...
/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\org\springframework\expression\spel\ast\OperatorMatches.class
