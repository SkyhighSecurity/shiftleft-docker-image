...
/*    */     {
/* 88 */       return (ObjectInstantiator<T>)new SunReflectionFactoryInstantiator(type);
/*    */     }
/* 90 */     if (PlatformDescription.isThisJVM("GNU libgcj")) {
/* 91 */       return (ObjectInstantiator<T>)new GCJInstantiator(type);
/*    */     }
/* 93 */     if (PlatformDescription.isThisJVM("PERC")) {
/* 94 */       return (ObjectInstantiator<T>)new PercInstantiator(type);
/*    */     }
/*    */ 
/*    */     
/* 98 */     return (ObjectInstantiator<T>)new UnsafeFactoryInstantiator(type);
/*    */   }
/*    */ }


/* Location:              C:\Users\nateb\Desktop\shiftleft-docker-image-1.2.0.jar!\org\springframework\objenesis\strategy\StdInstantiatorStrategy.class
